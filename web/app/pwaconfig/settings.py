...
PWA_SERVICE_WORKER_PATH = getattr(\
	settings, 'PWA_SERVICE_WORKER_PATH',\
	os.path.join(settings.BASE_DIR, 'templates', 'serviceworker.js'))
...
getattr(settings, 'PWA_APP_SPLASH_SCREEN', [
	{
	...
	{
		'src': '/static/imgs/icons/splash-828x1792.png',
		'media': '(device-width: 414px) and (device-height: 896px) and (-webkit-device-pixel-ratio: 2)'
	},
	{
		'src': '/static/imgs/icons/splash-1242x2688.png',
	...
	{
		'src': '/static/imgs/icons/splash-1668x2224.png',
		'media': '(device-width: 834px) and (device-height: 1112px) and (-webkit-device-pixel-ratio: 2)'
	},
	{
		'src': '/static/imgs/icons/splash-1668x2388.png',
		'media': '(device-width: 834px) and (device-height: 1194px) and (-webkit-device-pixel-ratio: 2)'
	},
	{
		'src': '/static/imgs/icons/splash-2048x2732.png',
